...
class Character(object):
    ...
    def SetEquip(self, itemname):
        ...
        Whatever that item is replacing is destroyed.  The group's
    ...
    def Equip(self, itemname, slot=None):
        ...
        The currently equipped item is put in the inventory, if
        applicable.
        
        If slot is omitted, the first applicable slot in the character's
        equip list is chosen.
        """
        item = itemdb[itemname]
        if slot is None:
    ...
    def CalcEquip(self):
        ...
        # cap evade and hit# to 99%
        self.stats.eva = min(self.stats.eva, 99)

...
{
	curdata.start=GetDlgItemInt(hWnd,IDC_EDFIRSTTILE,NULL,false);
	curdata.finish=GetDlgItemInt(hWnd,IDC_EDLASTTILE,NULL,false);
	curdata.delay=GetDlgItemInt(hWnd,IDC_EDDELAY,NULL,false);

	pVsp->SetAnim(curdata,nCurstrand);
}

void CVSPAnimDlg::UpdateDialog(HWND hWnd)
{
	pVsp->GetAnim(curdata,nCurstrand);

	SetDlgItemInt(hWnd,IDC_EDFIRSTTILE,curdata.start,false);
	SetDlgItemInt(hWnd,IDC_EDLASTTILE,curdata.finish,false);
	SetDlgItemInt(hWnd,IDC_EDDELAY,curdata.delay,false);

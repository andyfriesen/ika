...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\common" /I "$(PYTHON)\include" /I "..\3rdparty" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "MSVC" /D "INLINE_ASM" /FD /GZ /c
...
# ADD LINK32 comctl32.lib libpng.lib zlib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /debug /machine:I386 /libpath:"..\common" /libpath:"$(PYTHON)\lib" /libpath:"..\3rdparty"

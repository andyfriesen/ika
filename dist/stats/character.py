...
class Character(object):
    ...
    hp = property(lambda self: self.stats.hp, set_HP, doc="Gets or sets the character's current hitpoint count.")
    mp = property(lambda self: self.stats.mp, set_MP, doc="Gets or sets the character's current magic point count.")
    maxHP = property(lambda self: self.stats.maxhp, doc="Gets the character's current maximum hitpoint count.")
    maxMP = property(lambda self: self.stats.maxmp, doc="Gets the character's current maximum magic point count.")

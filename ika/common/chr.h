...
//	~CCHRfile();
	...
	inline int& HotY(int nFrame=0)		{	return nHoty;	}		// later on.  These four functions will have an optional frame
	inline int& HotW(int nFrame=0)		{	return nHotw;	}		// index argument added to them when this happens.

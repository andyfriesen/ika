...
MMEXPORT UTRK_WRITER *utrk_init(int nc);
MMEXPORT uint    utrk_cleanup(UTRK_WRITER *ut);
//MMEXPORT void    utrk_global_memflag(int memslot, int flags);
...
MMEXPORT UBYTE   *utrk_dup_track(UTRK_WRITER *ut, int chn);
MMEXPORT UBYTE   *utrk_dup_global(UTRK_WRITER *ut);

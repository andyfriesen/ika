...
bool gfxDirectBlitImage(handle img,int x,int y,int width,int height,bool transparent);					// Draws the image directly upon the client window.  This subverts showpage.

...
void CScriptEngine::AddEntityToList(int nEnt)
{
	PyObject* pEnt=Entity_New(0,Py_BuildValue("(i)",nEnt));				// make an object for the entity

	char c[1024];
	strcpy(c,pEngine->entities[nEnt].sName.c_str());
